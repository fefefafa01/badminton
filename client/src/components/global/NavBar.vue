          ...
          <div class="frame-4 grid-item4" style="z-index: 3">
              ...
              <div class="sliderPrice" :class="{ showSlider: isSliderVisible }">
                ...
                <div class="range-input">
                    <input type="range" class="range-min" min="0" max="200000" value="20000" step="1000">
                    <input type="range" class="range-max" min="0" max="200000" value="180000" step="1000">
                </div>
              </div>
          </div>
      ...
      rangeInput.forEach(input => {
        input.addEventListener("input" , e => {
          ...
          if(parseInt(this.minPrice) == 0){
            ...
            this.minPriceShow = parseInt(this.minPrice) / 1000 + "K";
          if(parseInt(this.maxPrice) == 0){
            this.maxPriceShow = parseInt(this.maxPrice) + "K";
          } else
            this.maxPriceShow = parseInt(this.maxPrice) / 1000 + "K";
