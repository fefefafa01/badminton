...
<script>
    ...
    export default {
        ...
        data() {
            return {
                item : null,
                times: ["6:00", "7:00", "8:00", "9:00", "10:00", "11:00", "12:00", "13:00", "14:00", "15:00", "16:00", "17:00", "18:00", "19:00", "20:00", "21:00", "22:00", "23:00", "24:00"],
                rows: [
                    { name: "Sân 1", schedule: Array(19).fill('circle') },
                    { name: "Sân 2", schedule: ['circle', 'circle', 'circle', 'filled', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'filled', 'circle', 'circle', 'circle', 'circle', 'circle'] },
                    { name: "Sân 3", schedule: ['circle', 'circle', 'circle', 'circle', 'filled', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle'] },
                    { name: "Sân 4", schedule: Array(19).fill('circle') },
                    { name: "Sân 5", schedule: ['circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'filled', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle'] },
                    { name: "Sân 6", schedule: ['circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'filled', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'filled', 'circle', 'circle', 'circle', 'circle'] },
