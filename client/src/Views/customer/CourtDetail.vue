                    ...
                    <tbody>
                        <tr v-for="(row, rowIndex) in rows" :key="rowIndex">
                            ...
                            <td class="frame" v-for="(cell, cellIndex) in row.schedule" :key="cellIndex">
                                <div v-if="cell === 'circle'"  class="filled"></div>
    ...
    export default {
        ...
        methods: {
            ...
            initializeRows( num_of_court, count_time) {
                const circleArray = Array(count_time).fill('circle')
                return {
                        name: `Sân ${num_of_court }`,
                        schedule: circleArray
                    };
                // const filledPattern = ['circle', 'circle', 'circle', 'filled', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'circle', 'filled', 'circle', 'circle', 'circle', 'circle', 'circle'];
                // const circleArray = Array(19).fill('circle');
                // this.rows = Array.from({ length: this.count }, (_, index) => {
                //     return {
                //         name: `Sân ${index + 1}`,
                //         schedule: index % 2 === 1 ? filledPattern : circleArray
                //     };
                // });
            },
            selectFrame() {
